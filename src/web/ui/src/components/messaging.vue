    ...
    <div class="head-section">
        ...
        <div class="headRight-section">
            <div class="headRight-sub">
                ...
                <small> {{ selectedUser.Name }} - {{ selectedUser.UID }}</small>
            </div>
        </div>
    </div>
        ...
        <div class="right-section">
                ...
                <ul>
                    ...
                    <li v-for="item in messages[selectedUser.UID]" :key="item.Key" :class="item.Local ? 'msg-right' : 'msg-left' ">
                        <div class="msg-left-sub">
							...
							<img  v-else src="../assets/imessage-icon.png">
            ...
            <div class="right-section-bottom">
                <form>
                    ...
                    <input type="text" name="" v-model="msgTxt" placeholder="type here...">
                    <button  v-on:click="myMethod" class="btn-send"><i class="fa fa-send"></i></button>
                </form>
            </div>
        </div>
    </div>
...
name: 'messaging',
  ...
  methods: {
	...
	myMethod: function myMethod(ev) {
	  ...
	  this.messages[this.selectedUser.UID].push(msg)
	  this.msgTxt=""
	},
    ...
    addMessage(toAdd) {
	    ...
	    if (this.messages[msg.From] === undefined) {
			this.messages[msg.From] = []
		}
